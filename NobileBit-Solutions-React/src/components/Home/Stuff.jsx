      ...
      <div className="container pt-5 pb-5">
        ...
        <div className="row align-items-center">
          <div className="col-lg-4 text-center mb-4 text-md-start">
            ...
            <p className="text-black-50 mb-3 fs-6">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos minus error quo necessitatibus 
              quibusdam similique. Sunt, recusandae necessitatibus reprehenderit aperiam magni repellendus 
              iure? Omnis deserunt voluptatum ullam veniam vitae harum.
            </p>
          ...
          <div className="col-lg-8">
            <img className="img-fluid" src="/assets/images/stuff.jpg" alt="stuff" />
          </div>
        </div>
      </div>
    </div>
